...
public final class D {
    ...
    public static final String BASE_DIR = "./CityOfHero";
    public static final String RESOURCE_DIR = "./Tools/Excel/";
    public static final String CFG_DIR = "game/cfg/";
    public static final String SRC_DIR = BASE_DIR + "/src/";
    public static final String XML_RESOURCE_DIR = BASE_DIR + "/resource/";
